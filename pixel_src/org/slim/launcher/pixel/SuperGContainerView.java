...
public class SuperGContainerView extends BaseQsbView {
    ...
    protected void onMeasure (int i, int i2) {
        ...
        size = DeviceProfile.calculateCellWidth(i5, deviceProfile.inv.numColumns) *
    ...
    protected void onLayout (boolean z, int i, int i2, int i3, int i4) {
        ...
        if (bz != null && mQsbView != null) {
            int i5 = 0;
            if (Utilities.isRtl(getResources())) {
                i5 = mQsbView.getLeft() -
                        mLauncher.getDeviceProfile().getWorkspacePadding(sTempRect).left;
            }
