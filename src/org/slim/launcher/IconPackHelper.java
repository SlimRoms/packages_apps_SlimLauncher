        ...
        if (!pickIcon) {
            ...
            builder.setAdapter(adapter, new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int position) {
                    ...
                    LauncherAppState.getInstance().getIconCache().updateDbIcons(new ArraySet<String>());
                    LauncherAppState.getInstance().getModel().refreshShortcutsIfRequired();
//                    LauncherAppState.getInstance().getModel().forceReload();
            ...
            builder.setAdapter(adapter, new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    SlimLauncher launcherActivity = (SlimLauncher) context;
                    if (TextUtils.isEmpty(selectedPackage) || TextUtils.equals(selectedPackage, "default")) {
                        launcherActivity.onActivityResult(
                                SlimLauncher.REQUEST_PICK_ICON, Activity.RESULT_OK, null);
                    } else {
                        Intent i = new Intent();
                        i.setClass(context, IconPickerActivity.class);
                        i.putExtra("package", selectedPackage);
                        launcherActivity.startActivityForResult(i, SlimLauncher.REQUEST_PICK_ICON);
                    }
                    dialog.dismiss();
                }
            });
            builder.setNeutralButton(R.string.reset_custom_icons,
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            ((SlimLauncher) context).onActivityResult(
                                    SlimLauncher.REQUEST_PICK_ICON, Activity.RESULT_OK, intent);
                        }
                    });
        }
        builder.show();
    ...
    private static class IconAdapter extends BaseAdapter {
        ...
        IconAdapter(Context ctx, Map<String, IconPackInfo> supportedPackages, boolean pickIcon) {
            ...
            mCurrentIconPack =
                    SettingsProvider.getString(ctx, SettingsProvider.KEY_ICON_PACK, "default");
