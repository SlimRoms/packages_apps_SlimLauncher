...
public class DoubleShadowTextClock extends TextClock {
    ...
    public DoubleShadowTextClock (Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes =
                context.obtainStyledAttributes(attributeSet, R.styleable.DoubleShadowTextClock, i,
                        0);
        ambientShadowBlur = obtainStyledAttributes
                .getDimension(R.styleable.DoubleShadowTextClock_ambientShadowBlur, 0.0f);
        keyShadowBlur = obtainStyledAttributes
                .getDimension(R.styleable.DoubleShadowTextClock_keyShadowBlur, 0.0f);
        keyShadowOffset = obtainStyledAttributes
                .getDimension(R.styleable.DoubleShadowTextClock_keyShadowOffset, 0.0f);
        ambientShadowColor = obtainStyledAttributes
                .getColor(R.styleable.DoubleShadowTextClock_ambientShadowColor, 0);
        keyShadowColor = obtainStyledAttributes
                .getColor(R.styleable.DoubleShadowTextClock_keyShadowColor, 0);
        obtainStyledAttributes.recycle();
        setShadowLayer(Math.max(keyShadowBlur + keyShadowOffset, ambientShadowBlur), 0.0f, 0.0f,
                keyShadowColor);
    }
