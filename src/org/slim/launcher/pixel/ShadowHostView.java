...
public class ShadowHostView extends FrameLayout {
    ...
    public static View bG (WeatherInfo gsa, ViewGroup viewGroup, View view) {
        ...
        if (view instanceof ShadowHostView) {
            ...
            view2 = (ShadowHostView) LayoutInflater.from(viewGroup.getContext())
                    .inflate(R.layout.shadow_host_view, viewGroup, false);
        }
    ...
    private boolean applyView (WeatherInfo gsa) {
        long[] jArr = new long[]{gsa.gsaUpdateTime, (long) gsa.gsaVersion,
                (long) gsa.mRemoteViews.getLayoutId()};
        if (mView != null) {
