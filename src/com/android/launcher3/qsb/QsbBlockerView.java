...
public class QsbBlockerView extends FrameLayout implements OnStateChangeListener,
    ...
    protected void onAttachedToWindow() {
        ...
        WeatherInfo weatherInfo = WeatherThing.getInstance(getContext())
                .getWeatherInfoAndAddListener(this);
    }
        ...
        if (mView == null) {
            ...
            if (view == null || i != 1) {
                inflate = LayoutInflater
                        .from(getContext()).inflate(R.layout.date_widget, this, false);
            } else {
                inflate = view;
            }
            mView = inflate;
