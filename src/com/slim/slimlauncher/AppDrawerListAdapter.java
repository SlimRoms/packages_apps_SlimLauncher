...
public class AppDrawerListAdapter extends RecyclerView.Adapter<AppDrawerListAdapter.ViewHolder>
    ...
    private void initParams() {
        ...
        mDrawerType = SettingsProvider.getInt(mLauncher, SettingsProvider.KEY_DRAWER_STYLE, 0);
    ...
    private void populateSectionHeaders() {
        ...
        for (int i = 0; i < mHeaderList.size(); i++) {
            ...
            if (info.mInfo.size() < mDeviceProfile.numColumns) {
                count++;
            } else {
                count += info.mInfo.size() / mDeviceProfile.numColumns;
            }
        }
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        for (int i = 0; i < mDeviceProfile.numColumns; i++) {
