...
public class IconPackHelper {
    ...
    private void parsePalettizedBackground(XmlPullParser parser, Map<ComponentName, String> iconPackResources) {
        ...
        for (int i = 0; i < attrCount; i++) {
            ...
            if (IMG_ATTR.equalsIgnoreCase(name)) {
                mIconPaletteBack = mLoadedIconPackResource.getDrawable(getResourceIdForDrawable(value));
