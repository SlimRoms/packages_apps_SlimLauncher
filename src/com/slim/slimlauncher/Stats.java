...
public class Stats {
    ...
    public static final String ACTION_LAUNCH = "com.slim.slimlauncher.action.LAUNCH";
    public static final String PERM_LAUNCH = "com.slim.slimlauncher.permission.RECEIVE_LAUNCH_BROADCASTS";
