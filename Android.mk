...
LOCAL_PACKAGE_NAME := SlimLauncher3Go
LOCAL_PRIVILEGED_MODULE := true
LOCAL_OVERRIDES_PACKAGES := Home Launcher2 Launcher3 Launcher3Go SlimLauncher

LOCAL_AAPT_FLAGS += --rename-manifest-package org.slim.launcher
